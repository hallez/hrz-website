	...
	<div class="row"><!-- class="row" -->
		<div class="col-xs-10">
			<table class="table table-hover">
				...
				<tbody>
					<tr>
						<td><a href="MickleySteinmetz_CogNeurosci2012_Final.pdf">Mickley Steinmetz, K. R., Schmidt, K., <span class="hrz-name">Zucker, H. R.</span>, & Kensinger, E. A. (2012). The effect of emotional arousal and retention delay on subsequent-memory effects. Cognitive Neuroscience, 3(3&ndash;4), 150&ndash;159. doi:10.1080/17588928.2012.677421
				</a></td>
					</tr>
				</tbody>
</table>
